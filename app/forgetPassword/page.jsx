import forget_password from "@/Assets/Images/Authentication_Images/forget_password.png";
...
const Page = () => {
  return (
    <main className="flex flex-col-reverse md:flex-row items-center justify-between gap-5 w-full min-h-screen md:-mt-8 px-7 my-5 py-5 md:my-0 md:py-0 md:px-0">
      <>
        <div className="flex flex-1 min-h-full flex-col justify-center py-0 lg:py-12 lg:px-8">
